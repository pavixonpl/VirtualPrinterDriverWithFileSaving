...
#warning tu nazwa drukarki
        ...
        private int DoXcvDataPortOperation(string portName, string portMonitor, string xcvDataOperation)
        {
            ...
            if (NativeMethods.OpenPrinter(",XcvMonitor " + portMonitor, ref hPrinter, def) != 0) //tutaj sypany jest błąd
            {
        ...
        private bool ConfigureclawPDFPort(String commandValue)
        {
            ...
            try
            {
                ...
                portConfiguration.SetValue("Description", "icpenPDF", RegistryValueKind.String);
